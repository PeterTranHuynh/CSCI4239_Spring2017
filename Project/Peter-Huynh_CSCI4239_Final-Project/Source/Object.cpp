...
void Object::setTH(float rot)
{
   th = (th > 360.0f) ? rot : th+rot;
}
void Object::setNX(float rot)
{
   nx = (nx > 360.0f) ? rot : nx+rot;
}
void Object::setNY(float rot)
{
   ny = (ny > 360.0f) ? rot : ny+rot;
}
void Object::setNZ(float rot)
{
   nz = (nz > 360.0f) ? rot : nz+rot;
}
