 ...
 *  File Notes:
 *    Shader 1, Custom RGB Strip Pattern Phone Lighting
 ***************************** */
// Intensity
varying float frontColor;

// REPLACE vec3 return with float
float phong()
{
   ...
   vec3 color = gl_FrontLightProduct[0].ambient.rgb             // Light[0] ambient
     + Id*gl_FrontLightProduct[0].diffuse.rgb                   // Light[0] diffuse
     + Is*gl_FrontLightProduct[0].specular.rgb;                 // Light[0] specular
